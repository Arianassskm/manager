...
foreach ($lines as $line) {
    ...
    imagettftext($image, $fontSize, 0, $x, $y, $textColor, '2.ttf', $line);
    $lineHeight = imagettftext($image, $fontSize, 0, $x, $y, $textColor, '2.ttf', $line)[1] - imagettftext($image, $fontSize, 0, $x, $y, $textColor, '2.ttf', $line)[7];
    $y += $lineHeight + 10;
}
